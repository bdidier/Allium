...
impl Sort for GamesSort {
    ...
    fn with_directory(&self, directory: Directory) -> Self {
        match self {
            GamesSort::Alphabetical(_) => GamesSort::Alphabetical(directory.clone()),
            GamesSort::LastPlayed(_) => GamesSort::LastPlayed(directory.clone()),
            GamesSort::MostPlayed(_) => GamesSort::MostPlayed(directory.clone()),
            GamesSort::Rating(_) => GamesSort::Rating(directory.clone()),
            GamesSort::ReleaseDate(_) => GamesSort::ReleaseDate(directory.clone()),
